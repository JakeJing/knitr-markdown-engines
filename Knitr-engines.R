#' ---
#' title: "Knitr with Other Engines"
#' author: "Yingqi Jing"
...
#' \clearpage
#' 
#' Compile c++ code chunk with Rcpp
#' ====
#' 
#' We can put the Rcpp code in a markdown chunk, when we knitr the file. It will evaluate the Rcpp code, and can use this defined function. But we cannot run this piece of c++ code directly in the R console.
#' 
#' ```{Rcpp, eval = T, run = T, cache=T}
#' #include <Rcpp.h>

...
\interlinepenalties 1 100
\displaywidowpenalties 1 10000
\interfootnotelinepenalties 1 10000
...
$if(author)${\normalsize $for(author)$$author$$sep$, $endfor$}$endif$
...
$if(keywords)$
\setlength\parindent{24pt} \keywords{$keywords$}
$endif$

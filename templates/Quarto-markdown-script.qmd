...
format:
  pdf: # latex or PrettyPDF-pdf (install at the project dir via quarto install extension nrennie/PrettyPDF)
    ...
    number-depth: 4
    # cite-method: biblatex # likely cause problems
    keep-tex: false
    colorlinks: true
    code-block-border-left: "white"
    code-block-bg: "#f8f8f8"
    include-in-header: /Users/jakejing/git/knitr-markdown-engines/templates/note-box.tex
...
execute:
  warning: false
filters: 
  - include-code-files # installed in your working dir (https://github.com/quarto-ext/include-code-files#readme)
---
...
```{.stan include="./Models/BM_vcv.stan"}
```

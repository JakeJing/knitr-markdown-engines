...
\SpecialCharTok{!}\NormalTok{[example picture](.}\SpecialCharTok{/}\NormalTok{figures}\SpecialCharTok{/}\NormalTok{histogram}\FloatTok{{-}1.}\NormalTok{png)\{width}\OtherTok{=}\DecValTok{90}\SpecialCharTok{\% height=80\%}\NormalTok{\}}

...
\hypertarget{color-stan-chunk}{%
\subsection{Color stan chunk}\label{color-stan-chunk}}
...
{\centering \includegraphics[width=1\linewidth,height=0.8\textheight]{./figures/histogram-rng-1} 

}

\caption{Histogram plot from \textcite{Rcore2020}}\label{fig:unnamed-chunk-5}
\end{figure}

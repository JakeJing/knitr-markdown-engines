...
\OperatorTok{!}\NormalTok{[example picture](.}\OperatorTok{/}\NormalTok{figures}\OperatorTok{/}\NormalTok{histogram}\FloatTok{-1.}\NormalTok{png)\{width=}\DecValTok{90}\OperatorTok{% height=80%}\NormalTok{\}}
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{include_graphics}\NormalTok{(}\StringTok{"./figures/histogram-rng-1.png"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
